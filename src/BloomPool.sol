...
constructor(BloomPoolParams memory params) ERC20(params.name, params.symbol, ERC20(params.underlyingToken).decimals()) {
    UNDERLYING_TOKEN = params.underlyingToken;
    BILL_TOKEN = params.billToken;
    WHITELIST = params.whitelist;
    SWAP_FACILITY = params.swapFacility;
    TREASURY = params.treasury;
    LENDER_RETURN_BPS_FEED = params.lenderReturnBpsFeed;
    EMERGENCY_HANDLER = params.emergencyHandler;
    LEVERAGE_BPS = params.leverageBps;
    MIN_BORROW_DEPOSIT = params.minBorrowDeposit;
    COMMIT_PHASE_END = block.timestamp + params.commitPhaseDuration;
    PRE_HOLD_SWAP_TIMEOUT_END = block.timestamp + params.commitPhaseDuration + params.preHoldSwapTimeout;
    POOL_PHASE_END = block.timestamp + params.commitPhaseDuration + params.poolPhaseDuration;
    POOL_PHASE_DURATION = params.poolPhaseDuration;
    LENDER_RETURN_FEE = params.lenderReturnFee;
    BORROWER_RETURN_FEE = params.borrowerReturnFee;
}
